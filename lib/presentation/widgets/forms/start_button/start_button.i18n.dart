...
extension Localization on String {
  ...
  static final _t = Translations.byText("de") +
      ...
      {
        "de": "Messung fortsetzen",
        "en": "Continue measurement",
      } +
      {
        "de": "Route fortsetzen?",
        "en": "Continue existing route?",
      } +
      {
      ...
      {
        "de": "Aktuelle Messung beenden?",
        "en": "End current measurement?",
      } +
      {
        "de": "Beenden",
        "en": "End now",
      ...
      {
        "de": "Transportmittel ändern",
        "en": "Change mode of transport",
      } +
      {
        "de": "Transportmittel wählen",
