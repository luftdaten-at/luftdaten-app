...
| `77db81d9-9773-49b4-aa17-16a2f93e95f2` | Device status / battery bytes |
...
For firmware-level packet layouts beyond this summary, refer to device firmware documentation or the parsing code in `ble_controller_v1.dart` / `ble_controller_v2.dart` / `ble_json_parser.dart`.
